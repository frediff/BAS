...
def insert_book(ISBN, book_title, author, language_, genre, price, copies, rack_number, vendor_name, vendor_mailID, vendor_mobile,  review = "-", rating = -1, average_procurement_time = 7, inventory_level = 0):
   ...
   if myresult:
       return "Error: The details of the book having the ISBN entered are aleady recorded!!"
